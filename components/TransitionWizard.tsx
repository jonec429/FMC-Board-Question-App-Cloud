        ...
        {step === 2 && (
          <div className="p-8 space-y-6 flex flex-col items-center justify-center text-center py-16">
            ...
            <p className="text-slate-500 max-w-lg text-lg">
              Because FMC QBank Cloud uses a cohort-based schema, <strong>PGY1s and PGY2s have automatically advanced</strong> to their next year based on the current date. No database updates are required!
            </p>
            <div className="pt-8">
              <button
                onClick={() => setStep(3)}
